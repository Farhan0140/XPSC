    ...
    private:
      ...
      void Propagate(ll Node, ll Begin, ll End) {
          ...
          if(Begin != End) {
              ...
              Lazy[ Left_Child ] = ( Lazy[ Left_Child ] * Lazy[ Node ] ) % mod;
              Lazy[ Right_Child ] = ( Lazy[ Right_Child ] * Lazy[ Node ] ) % mod;
      ...
      ll Merge(ll val_1, ll val_2) {
         
          return (val_1 + val_2) % mod;
      ...
      ll Query_Tree(ll Node, ll Begin, ll End, ll i, ll j) {
          ...
          return Merge( Query_Tree(Left_Child, Begin, Mid, i, j), Query_Tree(Right_Child, Mid + 1, End, i, j) );
