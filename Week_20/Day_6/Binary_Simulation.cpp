...
class Segment_Tree_Lazy {
    private:
      ...
      void Update_Tree(ll Node, ll Begin, ll End, ll i, ll j) {
          ...
          Update_Tree(Left_Child, Begin, Mid, i, j);
          Update_Tree(Right_Child, Mid + 1, End, i, j);
